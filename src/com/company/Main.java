...
public class Main {
    ...
    static final String MENTOR_CSV_FILE_PATH = "src/com/company/dec-19th-LBN Mentor Registration-export-data.csv";
    ...
    public static void main(String[] args) throws IOException {
        ...
        // For Mentors who have indicated availability, but there are no spots for them
